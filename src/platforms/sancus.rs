...
use manager_net::{AttestationRequestSancus};
use crate::error::Error;

pub fn sancus_attest(data : &AttestationRequestSancus) -> Result<()> {
    ...
    let mac = encrypt(&[], &data.key, &challenge, &Encryption::Spongent)?;
